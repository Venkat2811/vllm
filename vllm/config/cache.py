...
KVOffloadingBackend = Literal["native", "lmcache", "tensorpuffer", "wombatkv"]
...
class CacheConfig:
    ...
    'native' (vLLM native CPU offloading), 'lmcache', and TensorPuffer/WombatKV
    through an external OffloadingSpec.
